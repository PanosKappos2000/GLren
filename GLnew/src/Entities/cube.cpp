	...
	}
{
	...
	glm::mat4 perspective = Window::GetWindowInstance()->GetCamera()->GetPerspective();
...
void RotatingCube::OnUpdate()
{
	...
	glm::mat4 view(1.0f);
	view = Window::GetWindowInstance()->GetCamera()->GetLookAt();
	glm::mat4 model(1.0f);
	...
	model = glm::rotate(model,
		glm::radians(m_rotationSpeed * (float)glfwGetTime()), glm::vec3(1.0f, 1.0f, 1.0f));
